...
echo 'Enter INPUT file ("V4", "V9", "V4-unified" or "V9-unified"): '
read INPUT
fi
...
echo 'Enter forward primer (for V9 : "TTGTACACACCGCCC" ; for V4 : "GTG[CT]CAGC[AC]GCCGCGGTA"): '
read FWD
fi
## Reverse primer
...
echo 'Enter reverse primer (for V9 : "CCTTC[CT]GCAGGTTCACCTAC" ; for V4 : "TTGG[CT][AG]AATGCTTTCGC"): '
read REV
fi
